...
class ArtistTagDataTransformer implements DataTransformerInterface
{
    ...
    /**
     * @param ArtistTagService $artistTagService
     */
     ...
     * process that value.
     *
     * @param mixed $tags The value in the original representation
     *
     ...
     *
     * @return array The value in the original representation
     *
     * @throws TransformationFailedException when the transformation fails
     */
